...
export default function ProjectGalleryGrid({ gallery = [], projectTitle = '' }) {
  ...
  const renderVisual = (item, isLightbox = false) => {
        ...
        return (
          <div className="lightbox-photo-container">
            <img 
              src={item.imageSrc} 
              alt={item.title} 
              className="lightbox-activity-img" 
              loading="lazy" 
            />
          </div>
        );
    ...
    // Custom SVGs & Diagrams (for projects without raw photos)
    const content = (() => {
      switch (item?.type) {
        ...
        case 'shap-summary':
          return (
            <div className="gallery-card-bars">
              ...
              <div className="g-bar-item">
                <span className="g-bar-name">Cart Abandonment</span>
        ...
        case 'smote-dist':
          return (
            <svg className="gallery-svg" viewBox="0 0 320 180" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect width="320" height="180" rx="8" fill="#080808" />
              <text x="20" y="26" fill="rgba(255,255,255,0.6)" fontSize="9.5" fontFamily="monospace">TRAINING FOLD REBALANCING</text>
              ...
              <text x="20" y="160" fill="rgba(255,255,255,0.8)" fontSize="9" fontFamily="monospace">● Real  ○ Synthetic (SMOTE)</text>
            </svg>
          );
            ...
            <div className="sem-mini-diagram">
              ...
              <div className="sem-mini-arrows">
                <div className="s-arrow-row">
                  <span className="s-path-val">β = 0.918</span>
                  <div className="s-line" />
                </div>
                <div className="s-arrow-row">
                  <span className="s-path-val">β = 0.919</span>
                  <div className="s-line" />
                </div>
              </div>
            ...
            <div className="sample-demo-card">
              ...
              <div className="demo-stat-row">
                ...
                <div className="demo-tile">
                  ...
                  <span className="demo-lbl">Quality Ed.</span>
                </div>
              </div>
            </div>
          );
    ...
    if (isLightbox) {
      return (
        <div className="lightbox-visual-content">
          {content}
        </div>
      );
    }
    ...
    return (
      <div className="tilted-visual-wrapper">
        {content}
      </div>
    );
  };
  ...
  return (
    <div className="tilted-gallery-container">
      <div className="section-mini-heading">
        <ImageIcon size={16} />
        <span>PROJECT MEDIA & DOCUMENTATION GALLERY</span>
      </div>

      <div className="tilted-gallery-strip">
        {gallery.map((item, idx) => {
          const tiltClass = `tilted-card-${idx % 4}`;
          return (
            <div
              key={item.id || idx}
              className={`tilted-photo-card ${tiltClass}`}
            ...
            >
              <div className="tilted-photo-inner">
                {renderVisual(item, false)}
              </div>
              
              {/* Subtle hover badge on card */}
              <div className="tilted-photo-hover-pill">
                <Maximize2 size={12} />
                <span>EXPAND</span>
              </div>
            </div>
