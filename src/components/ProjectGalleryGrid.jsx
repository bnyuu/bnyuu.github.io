...
export default function ProjectGalleryGrid({ gallery = [], projectTitle = '' }) {
  ...
  // Check if this project uses photographic media (e.g., SmartSawit documentation)
  const isPhotoGallery = gallery.some((item) => item.imageSrc || item.type === 'image');
  ...
  return (
    <>
      {isPhotoGallery ? (
        /* --- Photo-based scattered / tilted layout (SmartSawit documentation) --- */
        ...
        /* --- Structured 2-column card grid (ML & Research Projects) --- */
